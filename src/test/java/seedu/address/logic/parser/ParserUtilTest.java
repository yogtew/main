...
public class ParserUtilTest {
    ...
    private static final String VALID_STUDENT_NUMBER = "123456";
    private static final String VALID_FACULTY = "123 Main Street #0505";
    ...
    public void parseStudentNumber_null_throwsNullPointerException() {
        Assert.assertThrows(NullPointerException.class, () -> ParserUtil.parseStudentNumber((String) null));
    }

    @Test
    public void parseStudentNumber_invalidValue_throwsParseException() {
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parseStudentNumber(INVALID_STUDENT_NUMBER));
    }
    ...
    public void parseAddress_null_throwsNullPointerException() {
        Assert.assertThrows(NullPointerException.class, () -> ParserUtil.parseFaculty((String) null));
    }

    @Test
    public void parseAddress_invalidValue_throwsParseException() {
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parseFaculty(INVALID_FACULTY));
    }
    ...
    public void parseAddress_validValueWithWhitespace_returnsTrimmedAddress() throws Exception {
        String addressWithWhitespace = WHITESPACE + VALID_FACULTY + WHITESPACE;
        Faculty expectedFaculty = new Faculty(VALID_FACULTY);
        assertEquals(expectedFaculty, ParserUtil.parseFaculty(addressWithWhitespace));
    }
