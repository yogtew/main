...
public class CommandTestUtil {
    ...
    public static final String PHONE_DESC_AMY = " " + PREFIX_STUDENT_NUMBER + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_STUDENT_NUMBER + VALID_PHONE_BOB;
    public static final String EMAIL_DESC_AMY = " " + PREFIX_EMAIL + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_EMAIL + VALID_EMAIL_BOB;
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_FACULTY + VALID_ADDRESS_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_FACULTY + VALID_ADDRESS_BOB;
    ...
    public static final String INVALID_PHONE_DESC = " " + PREFIX_STUDENT_NUMBER + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_FACULTY; // empty string not allowed for addresses
