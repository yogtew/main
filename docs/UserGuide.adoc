...
* The user can update the attendance of the student/students who are absent as 'absent'/'0' and who are present as 'present'/'1' (any other value updates the attendance to undefined).
