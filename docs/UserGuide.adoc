...
****
* The attendance marking as present is done individually, by using the index number of the student, and the user can individually group students who are absent as 'absent'/'0' and who are present as 'present'/'1'. The user can also collectively group the attendance using the GROUP feature. Then, the user can update the attendance of the students who do not follow the majority specifically.
****
