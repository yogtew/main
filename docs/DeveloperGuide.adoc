...
* End Time: The end time of the event, valid if it is later than the start time and is in this form: `HH:MM`, in 24-hour format.
...
* **Alternative 1 (current choice):** Simply display all events.
