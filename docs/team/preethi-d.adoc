...
** What it does: allows the user to email a student directly from the application through a command
...
able to sign-in with his/her email and send an email to their student.
